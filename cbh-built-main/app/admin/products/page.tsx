...
export default function AdminProductsPage() {
  ...
  const searchProducts = async () => {
    ...
    // Mock products - return empty for now (admin feature disabled)
    setError("Product search is currently unavailable. This feature requires external API access.");
    setLoading(false);
  };
  ...
  const loadStyles = async (product: SSProduct) => {
    ...
    // Mock styles - return empty for now
    setStyles([]);
    setViewMode("styles");
    setLoading(false);
  };
