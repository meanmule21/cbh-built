...
import { getSiteStats } from "@/data/mockData";
...
export default function Home() {
  ...
  const HATS_PRODUCED = stats.total_hats_produced;
  const CUSTOMERS_SERVED = stats.total_customers;
  const ORDERS_PLACED = stats.total_orders;
