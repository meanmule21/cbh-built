...
export default function CheckoutPage() {
  ...
  const handlePayNow = async () => {
    ...
    // Mock order submission - no API call needed
    setTimeout(() => {
      setIsLoading(false);
      alert("Order submitted! You will be contacted to complete payment and provide shipping information.");
    }, 1000);
  };
        ...
        <div className="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
          ...
          <div className="p-6">
            ...
            <p className="text-xs text-gray-500 text-center mt-3">
              You will be contacted to complete your order
            </p>
          </div>
        </div>
